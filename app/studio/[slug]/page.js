  ...
  if (!studio) {
    return (
      <div className="flex min-h-[85vh] flex-col items-center justify-center bg-white px-4 text-center dark:bg-black transition-colors duration-300">
        ...
        <h1 className="text-2xl font-extrabold text-zinc-900 dark:text-zinc-50">Studio Workspace Not Found</h1>
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-end gap-6 text-center sm:text-left">
              ...
              <div>
                ...
                <p className="mt-1.5 text-base text-zinc-550 dark:text-zinc-400 font-light flex items-center justify-center sm:justify-start gap-2">
                  <span className="font-semibold text-indigo-650 dark:text-indigo-400">Creative Studio Workspace</span>
                  {studio.location && (
                    <>
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5">
              <div className="rounded-2xl border border-zinc-200/80 bg-zinc-50/50 p-6 dark:border-zinc-850/50 dark:bg-zinc-950/40 text-left">
                <h3 className="text-sm font-bold text-zinc-900 dark:text-zinc-50 uppercase tracking-wider mb-4">Contact Studio</h3>
                
                <div className="space-y-4 text-sm font-medium">
                  {studio.email && (
                    <div className="flex items-start gap-3">
                      <svg className="h-5 w-5 text-indigo-650 dark:text-indigo-400 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                      <a href={`mailto:${studio.email}`} className="text-zinc-700 hover:text-indigo-650 dark:text-zinc-300 dark:hover:text-indigo-400 break-all">
                        {studio.email}
                      </a>
                    </div>
                  )}
