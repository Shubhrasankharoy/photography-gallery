    ...
    return (
      <div className="flex min-h-[70vh] items-center justify-center bg-[#F7F7F7] dark:bg-[#181818] transition-colors duration-300">
        <div className="flex flex-col items-center gap-2">
          ...
          <span className="text-sm text-[#8E8E8E] font-medium">Loading workspace...</span>
        </div>
      </div>
    );
  }
    ...
    >
      <div className="flex items-center gap-4 border-b border-zinc-200/50 pb-5 dark:border-zinc-800/40">
        ...
        <div>
          ...
          <p className="text-xs text-[#8E8E8E] font-light mt-0.5">Establish a new brand space and team hub.</p>
        </div>
      </div>

      <form onSubmit={handleSubmit} className="mt-8 space-y-6">
        {saveError && (
          <div className="rounded-[12px] bg-rose-50 border border-rose-200/80 p-4 dark:bg-rose-950/20 dark:border-rose-900/50 flex items-start gap-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="rounded-[20px] border border-zinc-200/60 bg-white p-6 dark:border-zinc-800/40 dark:bg-[#262626] flex flex-col items-center">
            ...
            <div className="relative h-24 w-24 rounded-full bg-zinc-100 dark:bg-[#181818] border border-zinc-200/60 dark:border-zinc-800 overflow-hidden flex items-center justify-center">
              {logoPreview ? (
            ...
            <label className="mt-4 rounded-[12px] bg-white border border-zinc-200/60 dark:border-zinc-800/40 dark:bg-[#262626] dark:hover:bg-[#2D2D2D] px-4 py-2.5 text-xs font-bold text-[#D4AF37] hover:bg-zinc-50 cursor-pointer shadow-xs select-none">
              Upload Logo
