            ...
            <div className="border-t border-zinc-200 dark:border-zinc-850 pt-8">
              ...
              <form onSubmit={handleCreateFolder} className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 dark:text-zinc-50 font-light text-sm placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400"
                />
